...
@pytest.mark.parametrize("source", ["https://www.bilibili.com/video/BV1xx411c7mD", "https://b23.tv/abc"])
def test_fetch_text_marks_bilibili_unsupported_before_fetching(source):
